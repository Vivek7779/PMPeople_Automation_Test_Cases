...
public class T5_SH extends BaseClass {
	...
	public void SH() throws IOException, InterruptedException {
		...
		WebElement SH=driver.findElement(By.xpath("/html/body/div/body/main/aside/nav/div/div[2]/div/ul/li[8]/a/img[1]"));
	    clickWithPause(SH);
	    
	    WebElement SelectBU=driver.findElement(By.xpath("//*[@id=\"floatingSelect\"]"));
	    SelectBU.click();
	    ...
	    WebElement ValueGreaterOrEqual=driver.findElement(By.xpath("/html/body/div/body/main/div[3]/div[2]/div/div/div/div/div[1]/div[2]/div[3]/div/div/div/div/div[8]/div/input"));
	    clickWithPause(ValueGreaterOrEqual);
	    ValueGreaterOrEqual.sendKeys("1");
	    
	    WebElement ValueSmallerOrEqual=driver.findElement(By.xpath("/html/body/div/body/main/div[3]/div[2]/div/div/div/div/div[1]/div[2]/div[3]/div/div/div/div/div[9]/div/input"));
	    ...
	    WebElement StartDate=driver.findElement(By.xpath("//*[@id=\"tab_PROJECTS\"]/div[1]/div[2]/div[3]/div/div/div/div/div[10]/div[1]/div/div/input"));
	    clickWithPause(StartDate);
	    StartDate.sendKeys("2018-01-10");
	    
	    WebElement FinishDate=driver.findElement(By.xpath("//*[@id=\"tab_PROJECTS\"]/div[1]/div[2]/div[3]/div/div/div/div/div[11]/div[1]/div/div/input"));
	    ...
	    WebElement ProjectSize=driver.findElement(By.xpath("/html/body/div/body/main/div[3]/div[2]/div/div/div/div/div[1]/div[2]/div[3]/div/div/div/div/div[12]/div/input"));
