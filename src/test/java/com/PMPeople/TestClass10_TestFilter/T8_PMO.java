...
public class T8_PMO extends BaseClass{

	@Test
	public void PMO() throws IOException, InterruptedException { //PORTFOLIO AND PROGRAM REMAINING
		driverinitialize();
		maximizeWindow();
		performLogin("admin11@dummy.com", "Admin@123");
		
		WebElement PMO=driver.findElement(By.xpath("/html/body/div/body/main/aside/nav/div/div[2]/div/ul/li[11]/a"));
	    clickWithPause(PMO);
	    ...
	    WebElement Filter=driver.findElement(By.id("//*[@id=\"react-aria4168367609-:rb:\"]"));
	    ...
	    WebElement SelectPMAssistant=driver.findElement(By.xpath("//*[@id=\"tab_PROJECTS\"]/div[1]/div[2]/div[4]/div/div/div/div/div[5]/div/label"));
	    ...
	    WebElement Client=driver.findElement(By.xpath("//*[@id=\"tab_PROJECTS\"]/div[1]/div[2]/div[4]/div/div/div/div/div[6]/div/div"));
	    ...
	    WebElement ProjectManager=driver.findElement(By.xpath("/html/body/div/body/main/div[3]/div[3]/div/div/div/div/div[1]/div[2]/div[4]/div/div/div/div/div[7]/div/select"));
	    ...
	    WebElement Phase=driver.findElement(By.xpath("//*[@id=\"tab_PROJECTS\"]/div[1]/div[2]/div[4]/div/div/div/div/div[8]/div/div/div"));
	    ...
	    WebElement ValueGreaterOrEqual=driver.findElement(By.xpath("/html/body/div/body/main/div[3]/div[3]/div/div/div/div/div[1]/div[2]/div[4]/div/div/div/div/div[11]/div/input"));
	    clickWithPause(ValueGreaterOrEqual);
	    ValueGreaterOrEqual.sendKeys("1");
	    
	    WebElement ValueSmallerOrEqual=driver.findElement(By.xpath("/html/body/div/body/main/div[3]/div[3]/div/div/div/div/div[1]/div[2]/div[4]/div/div/div/div/div[12]/div/input"));
	    ...
	    WebElement StartDate=driver.findElement(By.xpath("//*[@id=\"tab_PROJECTS\"]/div[1]/div[2]/div[4]/div/div/div/div/div[13]/div[1]/div/div/input"));
	    clickWithPause(StartDate);
	    StartDate.sendKeys("2018-01-10");
	    
	    WebElement FinishDate=driver.findElement(By.xpath("//*[@id=\"tab_PROJECTS\"]/div[1]/div[2]/div[4]/div/div/div/div/div[14]/div[1]/div"));
