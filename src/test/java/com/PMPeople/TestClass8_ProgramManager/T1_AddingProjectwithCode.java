package com.PMPeople.TestClass8_ProgramManager;
...
public class T1_AddingProjectwithCode extends BaseClass{
	...
	public void addingProjectwithCode () throws IOException, InterruptedException {
         ...
         WebElement FunctionalManager=driver.findElement(By.xpath("/html/body/div/body/main/aside/nav/div/div[2]/div/ul/li[9]/a"));
          ...
          WebElement PgM=driver.findElement(By.xpath("//a[@href=\"/pmi/supply/programmanager\"]"));
          clickWithPause(PgM);
          
          WebElement Selectprogram=driver.findElement(By.xpath("//*[@id=\"floatingSelect\"]"));
          clickWithPause(Selectprogram);
          Selectprogram.sendKeys(Keys.ARROW_DOWN,Keys.ARROW_DOWN,Keys.ENTER);
          ...
          Selectprogram1.sendKeys(Keys.ARROW_DOWN,Keys.ARROW_DOWN,Keys.ENTER);
